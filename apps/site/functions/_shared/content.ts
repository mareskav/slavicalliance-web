...
export const fallbackNapsaliONas = `---
title: "Napsali o nás"
---

## Slavic Alliance a jejich cesta na vrchol
- Zdroj: Hospodský kvíz
- Typ: facebook
- Datum: 14. července 2026
- Odkaz: https://www.facebook.com/hospodskykviz.cz/posts/pfbid0Cn395B9Fesiwj4if8WGrXK3XLY2HBAnwScUo255psPtYG9924KVVsABtA9qHoFQAl
- Obrázek: /press-facebook.jpg

Oficiální stránka Hospodského kvízu na Facebooku zmínila náš tým ve svém příspěvku.

## Mistrovství republiky v Hospodském kvízu: Lovci z Novy dostali na frak! Kdo jim vzal trůn?
- Zdroj: Blesk.cz
- Typ: article
- Datum: 13. července 2026
- Odkaz: https://www.blesk.cz/clanek/celebrity-serialy-filmy-kino-a-tv/843801/mistrovstvi-republiky-v-hospodskem-kvizu-lovci-z-novy-dostali-na-frak-kdo-jim-vzal-trun.html?kapitola=3876274
- Abstract: Pražský tým Slavic Alliance ovládl mistrovství republiky v Hospodském kvízu v Pardubicích a o pouhé tři body sesadil z trůnu obhájce z týmu iMumlynátů.
`

export const fallbackPages: Record<string, string> = {
  landing: fallbackLanding,
  "napsali-o-nas": fallbackNapsaliONas
}
